...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `validar_email_pro2fp` BEFORE INSERT ON `usuario` FOR EACH ROW BEGIN
	IF NEW.email NOT REGEXP '^[A-Za-z0-9._%+-]+@pro2fp\\.es$' THEN
		SIGNAL SQLSTATE '45000'
        SET MESSAGE_TEXT = 'El email debe terminar en @pro2fp.es';
	END IF;
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `validar_email_pro2fp_update` BEFORE UPDATE ON `usuario` FOR EACH ROW BEGIN
	IF NEW.email NOT REGEXP '^[A-Za-z0-9._%+-]+@pro2fp\\.es$' THEN
		SIGNAL SQLSTATE '45000'
        SET MESSAGE_TEXT = 'El email debe terminar en @pro2fp.es';
	END IF;
...
-- Dump completed on 2025-03-20 10:19:28
